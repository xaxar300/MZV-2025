...
Rule::Chain(14, TS('t'), TS('f'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('r'), NS('E'), TS(';'), TS('}'), TS(';'), TS(';'), NS('S')),
Rule::Chain(15, TS('t'), TS('f'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('r'), NS('E'), TS(';'), TS('}'), TS(';'), TS(';'))
),
Rule(NS('N'), GRB_ERROR_SERIES + 1,
///N-> pE;|i=E;|dti;N|pE;N|i=E;N|dtfi(F);N|dti(F);N - операторы
7,
...
///E->{i|l|(E)|i(W)|iM|i(W)M - выражения
6,
Rule::Chain(1, TS('i')),
Rule::Chain(1, TS('l')),
